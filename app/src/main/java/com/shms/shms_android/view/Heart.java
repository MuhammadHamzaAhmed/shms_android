...
import com.shms.shms_android.controller.HeartController;
...
public class Heart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = findViewById(R.id.heart_cards);
        back = findViewById(R.id.back_heart);
        user = (User) getIntent().getSerializableExtra("user");
        HeartController con = new HeartController(this);
